...
public class DosenTetap extends Dosen{
    ...
    /* Konstruktor DosenTetap dengan data default */
    public DosenTetap(){
        new Dosen();
        nidn = "";
    ...
    /* Konstruktor DosenTetap dengan data berdasarkan input */
    public DosenTetap(String nidn, String fakultas, String nip, String nama, LocalDate tanggaLahir, LocalDate tmt, int gajiPokok){
        super(fakultas, nip, nama, tanggaLahir, tmt, gajiPokok, "Dosen Tetap");
        this.nidn = nidn;
    }

    /* Selektor */
    /* Mengembalikan data NIDN */
    ...
    @Override
    /* Mencetak keseluruhan data pada atribut DosenTetap */
    public void printInfo(){
        ...
        System.out.println("Tunjangan: 2% x " + getMasaKerja().getYears() + " x Rp " + getgajiPokok() + ",00 = Rp. " + getTunjangan() + ",00");
    }
}
